...
//    float radius;
//
//    Ball(Vec2 pos, float r) : position(pos), velocity({ 0, 0 }), radius(r) {}  // Initially set velocity to zero
//
...
//            gravityEnabled = true;  // Enable gravity when spacebar is pressed
//        }
//
//        quadtree.clear();
//
...
//        for (Ball& ball : balls) {
//            if (gravityEnabled) {
//                ball.velocity.y -= 9.8f * dt;  // Apply gravity after spacebar press
//            }
